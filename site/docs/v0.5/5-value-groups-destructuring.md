...
values. Value groups are not heap-allocated objects. They map directly to consecutive
stack slots on the SLUR VM, making them zero-cost at runtime.
...
Use an inline product type when fields need names:
...
Spread can also pass a value group into a variadic position:
